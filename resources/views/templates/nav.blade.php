...
<nav class="navbar navbar-default" role="navigation">
  ...
  <div class="collapse navbar-collapse" id="navbar-brand-centered">
    <ul class="nav navbar-nav navbar-left">
      <li><a href="{{ secure_url('donate') }}">{{ trans('general.nav.donate') }}</a></li>
			<li><a href="{{ secure_url('vote') }}">{{ trans('general.nav.vote') }}</a></li>
    </ul>
    <ul class="nav navbar-nav navbar-right">
      <li><a href="{{ secure_url('about') }}">{{ trans('general.nav.about') }}</a></li>
			<li><a href="{{ secure_url('credits') }}">{{ trans('general.nav.credits') }}</a></li>		        
    </ul>
  </div>
</nav>
